...
public class UChromaKey_editor : Editor {
	...
	public override void OnInspectorGUI()
	{
		...
		{
			uck.threeColors = EditorGUILayout.ToggleLeft("3 colors", uck.threeColors);
			uck.SelectedColor = EditorGUILayout.ColorField("Chroma key color",uck.SelectedColor);
			if (uck.threeColors)
			{
				uck.SelectedColor2 = EditorGUILayout.ColorField("Chroma key color #2",uck.SelectedColor2);
				uck.SelectedColor3 = EditorGUILayout.ColorField("Chroma key color #3",uck.SelectedColor3);
			}
			else
