namespace Mapbox.Examples
{
    ...
    public class QuadTreeCameraMovementNew : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ARManager.instance.CallWhenARManagerInitialized(ContinueWhenARManagerInited);
        }
        ...
        void ContinueWhenARManagerInited()
        {
            ...
            geolocatedContentManager = ARManager.instance.GetGeoLocatedContentManager().GetComponent<ContentManager>();
        }
        ...
        public void Update()
        {
            ...
            if (onlyWhenLookingDown && !ARManager.IsMainCameraLookingDown() || ARUIManager.Instance.GetPreventPanAndZoom() || geolocatedContentManager.IsRTHandleSelected()) return;
            ...
            if (dragging)
            {
                ...
                if (mouseWorldPositionChange.sqrMagnitude > 0)
                {
                    ...
                    if (absoluteMouseWorldPositionOffset.sqrMagnitude > 0 && miniMap != null)
                    {
                        ...
                        if (ARManager.instance.geolocatedObjectsFixed)// useNewMethod)
                        {
